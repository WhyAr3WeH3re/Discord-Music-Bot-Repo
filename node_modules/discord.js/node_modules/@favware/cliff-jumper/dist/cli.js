...
const { reason, releaseType } = await doActionAndLog('Retrieving the strategy to use for bumping the package', //
...
console.info(cyan(`${blue('ℹ️')} Bumping the ${yellow(`${getReleaseType(options, releaseType)}`)} version of ${blueBright(getFullPackageName(options))}: ${yellow(reason)}`));
let newVersion;
